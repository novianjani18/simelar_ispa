...
class KelembapanIspaController extends Controller
{
    ...
    public function update(Request $request, string $id)
    {
        ...
        return redirect()->route('admin.kelembapan-ispa.index')->with('success', 'Kelembaban ISPA berhasil diperbarui.');
    }
    ...
    public function destroy($id)
    {
        ...
        // Hapus data kelembabanIspa
        $kelembapanIspa->delete();
        return redirect()->route('admin.kelembapan-ispa.index')->with('success', 'Kelembaban ISPA berhasil dihapus!');
    }
}
