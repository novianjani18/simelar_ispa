...
@section('title', 'Edit Kelembaban ISPA')
    ...
    <div class="page-content">
        ...
        <nav class="page-breadcrumb">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item"><a href="{{ route('admin.kelembapan-ispa.index') }}">Kelembaban ISPA</a>
                </li>
                <li class="breadcrumb-item active" aria-current="page">Edit Kelembaban ISPA</li>
            </ol>
        </nav>
