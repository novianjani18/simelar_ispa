...
@section('content')
    <button id="hamburger"
        ...
        <div style="width: 100%; height: 1px; background-color: #356332;"></div>
        <div style="width: 100%; height: 1px; background-color: #356332;"></div>
        <div style="width: 100%; height: 1px; background-color: #356332;"></div>
    ...
    <div id="filter"
        class="fixed right-10 border border-slate-200 z-30 top-56 rounded w-fit h-fit p-4 bg-white drop-shadow-md hidden">
        <h1>Filter</h1>
    ...
    <script>
        ...
        kelembapanIspaParam.addEventListener('click', function() {
            title.innerHTML = 'Kelembaban Lingkungan'
            kasusIspaParam.classList.remove('font-bold')
            kepadatanIspaParam.classList.remove('font-bold')
            suhuIspaParam.classList.remove('font-bold')
            curahIspaParam.classList.remove('font-bold')
