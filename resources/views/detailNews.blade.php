...
@section('content')
    ...
    <div class="relative h-[730px] w-auto flex flex-col justify-center items-center">
        ...
        <div class="absolute bottom-0 left-0 right-0 h-[6px]" data-aos="fade-up"
            style="background: linear-gradient(90deg,  #6E9C6B 20%, #6E9C6B 36%, #6E9C6B 76%">
        </div>
        <div data-aos="fade-up">
            <h1 class="text-[36px] md:text-[64px] ml-6 md:ml-0 font-Anek font-bold uppercase text-[#6E9C6B]"
                data-aos="fade-up">
    ...
    <div class="md:px-[100px] px-[50px] mt-[100px]">
        ...
        <div class="flex flex-col justify-center items-center">
            <h1 class="font-Anek font-bold text-[32px] md:text-[44px] text-[#6E9C6B]" data-aos="fade-up">BERITA YANG LAINNYA TENTANG ISPA...</h1>
            <!-- <p
